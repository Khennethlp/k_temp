...
<nav class="main-header navbar navbar-expand-md navbar-dark bg-gray-dark text-light border-bottom-0">
  <a href="" class="navbar-brand ml-2">
    <img src="../../dist/img/logo.png" alt="Web Template Logo" class="brand-image elevation-3 rounded bg-light p-1" style="opacity: .8">
  ...
  <div class="collapse navbar-collapse order-3" id="navbarCollapse">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a href="" class="nav-link "><i class="fas fa-home"></i> Homepage</a>
      </li>
      <li class="nav-item">
